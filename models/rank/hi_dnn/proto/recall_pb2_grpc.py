...
class RecallServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.recall = channel.unary_unary(
                '/recall_server.RecallService/recall',
...
def add_RecallServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'recall_server.RecallService', rpc_method_handlers)
...
class RecallService(object):
    ...
    def recall(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/recall_server.RecallService/recall',
